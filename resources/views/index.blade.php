    ...
    <div class="container mx-auto mt-10">
        <div class="flex justify-center">
            <div
                ...
                <h1
                    class="max-w-sm mb-5 mx-auto text-3xl tracking-tighter text-balance sm:text-4xl lg:text-5xl xl:text-7xl text-gray-500 dark:text-gray-300">
                ...
                <form class="max-w-sm mx-auto" method="POST" action="/">
                    ...
                    <label for="start" class="block mb-2 text-sm font-medium  text-gray-500 dark:text-gray-400">Date
                        Range</label>
                    <div class="mb-5 flex items-center">
                        <div class="relative">
                            ...
                            <input id="datepicker-actions-start" name="start" datepicker datepicker-buttons
                        ...
                        <div class="relative">
                            ...
                            <input id="datepicker-actions-end" name="end" datepicker datepicker-buttons
                                datepicker-autoselect-today type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
